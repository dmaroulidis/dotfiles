...
alias upgrade-hosts="cd ~/Projects/home-sysadmin && ansible-playbook -i inventory/penteli -i inventory/chania -i inventory/oracle-cloud -i inventory/google-cloud --ask-become-pass -f 30 ./playbooks/apt.yml; cd -"
